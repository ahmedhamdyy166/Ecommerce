...
export default function CartDetails({cartProduct , removeProductfromCart,updateCartProductCount}) {
    ...
    <div className="cart-product shadow rounded-2 my-3">
        <div className="row align-items-center">
          ...
          <div className="col-md-8">
            ...
            <p><span className="fw-bolder">Total Price:</span>{cartProduct.price*cartProduct.count}</p>
